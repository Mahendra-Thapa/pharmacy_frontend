       ...
       <div className=" flex gap-2 items-center">
        ...
        <div className="hidden lg:flex items-center gap-6 shrink-0">
            ...
            <Link href="/cart" className="relative group flex flex-col items-center gap-1.5 text-slate-400 hover:text-pharma-blue transition-all">
               ...
               <span className="text-[9px] font-black uppercase tracking-widest">Basket</span>
            </Link>
                        ...
                        >
                           ...
                           <div className="p-2 space-y-1">
                              {[
                                ...
                                { name: 'Order History', href: '/user/orders', icon: FileUp },
                                { name: 'Security Settings', href: '/user/security', icon: MapPin },
                                { name: 'Saved Addresses', href: '/user/addresses', icon: MapPin },
                                { name: 'Notifications', href: '/user/notifications', icon: Percent },
                              ].map(item => (
