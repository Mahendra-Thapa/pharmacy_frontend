          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            {user ? (
              <div className="relative">
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-slate-900 flex items-center justify-center text-white  overflow-hidden">
                     <UserIcon size={18} />
                  </div>
                  <div className="hidden md:flex flex-col text-left">
                     <span className="text-[9px] font-bold uppercase text-slate-400 leading-none mb-0.5">{user.first_name}</span>
                  ...
                  {showUserMenu && (
                    <>
                      ...
                      <motion.div 
                        ...
                        className="absolute top-full right-0 mt-3 w-[200px] bg-white rounded-sm border border-slate-100  z-50 overflow-hidden divide-y divide-slate-50"
                      >
                         ...
                         <div className="p-2">
                            <button 
                              ...
                              className="w-full flex items-center gap-3 p-3 rounded-2xl hover:bg-rose-50 text-slate-600 hover:text-rose-500 transition-all font-bold text-[10px] uppercase tracking-widest cursor-pointer"
                            >
              ...
              <Link
                href="/login"
                className="h-10 px-6 bg-slate-900 hover:bg-pharma-blue text-white rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all  active:scale-95 flex items-center justify-center"
              >
                Login
              </Link>
            )}
