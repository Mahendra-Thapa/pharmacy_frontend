      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 pt-40 pb-24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-3xl font-bold text-slate-950 tracking-tighter leading-tight">
              Healthcare
          ...
          <div className="flex items-center gap-3">
            ...
            <Select onValueChange={(value) => setActiveCategory(value)} defaultValue="All">
              <SelectTrigger className="w-[180px] rounded-md text-[11px] font-bold uppercase tracking-widest transition shadow-sm active:scale-95 whitespace-nowrap bg-white text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 border border-slate-100">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <section className="flex-1">
            <motion.div
              className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 gap-8"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={{
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 rounded-[32px] bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden group ">
                ...
                <div className="relative z-10">
                  ...
                  <button className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-emerald-400 hover:text-emerald-300 transition">
                    Learn More <ChevronRight size={16} />
                  </button>
                </div>
              </div>

              <div className="p-8 rounded-[32px] bg-white border border-slate-100 Login relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <button className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-emerald-600 hover:text-emerald-500 transition">
