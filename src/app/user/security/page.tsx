    ...
    return (
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                <Card className="lg:col-span-2 rounded-xl border-transparent shadow-xl bg-white p-8 lg:p-12">
                    <form onSubmit={handleSubmit(onUpdate)} className="space-y-8">
                        ...
                        <div className="flex justify-end border-t border-slate-50 pt-8 mt-8">
                            <Button disabled={loading} type="submit" className="h-14 px-12 bg-slate-900 hover:bg-pharma-blue text-white rounded-sm font-black uppercase tracking-widest shadow-xl transition-all active:scale-95 disabled:opacity-50">
